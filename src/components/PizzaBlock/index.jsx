...
import PizzaBlockTools from '../PizzaBlockTools';
...
export default function PizzaBlock ({ title, imageUrl, price, sizes, types }) {
    ...
    return (
        <div className='pizza-block'>
            <img src={imageUrl} className="pizza-block__img mb-11" alt='pizza' />
            <div className="pizza-block__title mb-22">{title}</div>
            <PizzaBlockTools size={sizes} type={types} />
            <div className="pizza-block__bottom mt-17">
                ...
                <Button outlined>
                    ...
                    <div className='ml-8 mr-9'>Добавить</div>
                    <div className='button-count'>{countPizzas}</div>
                </Button>
            </div>
        </div>
    )
